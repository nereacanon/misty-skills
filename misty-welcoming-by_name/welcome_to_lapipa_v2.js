...
function _SendExternalRequest(data) { // When we get here, we ALWAYS have a response
    ...
    if(!response.results[0].alternatives[0].transcript){ // This checks if the person's name was obtained
